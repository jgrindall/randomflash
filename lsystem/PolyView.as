...
class PolyView {
	...
	private static var ballAlpha:Number = 90;
	...
	public var poly;
	public function PolyView(radius:Number, target_mc:MovieClip, depth:Number, x:Number, y:Number, v:Array, j:Array, d:Array) {
		this.radius = radius;
	...
	public function makeSurf():Void {
		poly = new Surface(v, j, d, target_mc.container_mc.poly_mc, radius);
	}
	...
	public function makeBall():Void {
		...
		target_mc.container_mc.ball_mc.beginFill(0xffffff, 70);
