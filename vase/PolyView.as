...
class PolyView {
	...
	public function PolyView(v:Array, radius:Number, target_mc:MovieClip, depth:Number, x:Number, y:Number, l:Array, d:Array) {
		this.radius = radius;
	...
	public function makeSurf(v:Array):Void {
