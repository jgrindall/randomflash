...
class PolyView {
	...
	public function makeData(x:Number, y:Number):Void {
		target_mc.container_mc.data_mc.createTextField("dataMess", 1, x-50, y-radius-60, 100, 30);
		target_mc.container_mc.data_mc.dataMess.autoSize = true;
		target_mc.container_mc.data_mc.dataMess.selectable = false;
		target_mc.container_mc.data_mc.dataMess.text = "Vertices   Edges    Faces";
		//
		target_mc.container_mc.data_mc.createTextField("nameMess", 2, x-50, y-radius-80, 100, 30);
		target_mc.container_mc.data_mc.nameMess.autoSize = true;
		target_mc.container_mc.data_mc.nameMess.selectable = false;
		target_mc.container_mc.data_mc.nameMess.text = "";
		//
		target_mc.container_mc.data_mc.createTextField("data2Mess", 3, x-50, y-radius-40, 100, 30);
		target_mc.container_mc.data_mc.data2Mess.autoSize = true;
		target_mc.container_mc.data_mc.data2Mess.selectable = false;
	...
	public function makeListBox(x:Number, y:Number):Void {
		...
		target_mc.container_mc.lists_mc.listBox.move(x-radius-210, y-radius-70);
	...
	public function makeDualBut(x:Number, y:Number):Void {
		...
		target_mc.container_mc.lists_mc.dualBut.move(x-radius-210, y-radius+285);
	...
	public function makeColors(x:Number, y:Number):Void {
		var m:MovieClip;
		var thisP:PolyView = this;
		target_mc.container_mc.lists_mc.createTextField("colorMess", colorButDepth, x-radius-210, y-radius+250, 100, 30);
		...
		for (i=0; i<=lightcolor.length; i++) {
			...
			m.ind = i;
			m._x = x-radius-125+(1.1*butSize*2)*i;
			m._y = y-radius+260
